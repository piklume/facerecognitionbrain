                    ...
                    <main className="pa4 black-80">
                        <div className="measure">
                            ...
                            <div className="mv3">
                                ...
                                <input 
                                    onChange = {this.onPasswordChange} onKeyPress = { this.onEnterPress }
                            ...
                            <p onClick = {() => onRouteChange('signin')} href="#0" className="f6 link dim black db pointer">Go Back</p>
                            </div>
                        </div>
                    </main>
                </article>
